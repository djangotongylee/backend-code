 ...
 * @since 2021-02-01
 */
@TableName("sp_betslips_cq9_thunder_fighter")
public class BetslipsCq9ThunderFighter extends Model<BetslipsCq9ThunderFighter> {
...
※table 會回傳空陣列
    ...
    public String toString() {
        return "BetslipsCq9ThunderFighter{" +
        "id=" + id +
        ", xbUid=" + xbUid +
