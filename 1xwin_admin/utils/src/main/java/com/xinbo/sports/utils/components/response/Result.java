...
import static com.xinbo.sports.utils.components.response.CodeInfo.STATUS_CODE_SUCCESS;
...
public class Result<T> {
    ...
    public Result(T data) {
        this.code = STATUS_CODE_SUCCESS.getCode();
        this.msg = STATUS_CODE_SUCCESS.getMsg();
        this.data = data;
    }
    ...
    public static Result<String> ok() {
        return new Result<>(STATUS_CODE_SUCCESS);
    }
    ...
    public static <K> Result<K> ok(K data) {
        return new Result<>(STATUS_CODE_SUCCESS.getCode(), STATUS_CODE_SUCCESS.getMsg(), data);
    }
