...
public class HttpUtils {
    ...
    private static ThreadPoolExecutor httpPool = new ThreadPoolExecutor(
            32,
            32,
            300L,
            TimeUnit.MINUTES,
     ...
     * @param model      调用类
     */
    public static String doPost(String url, JSONObject postData, Map<String, String> headerData, String model) throws Exception {
        String result = "";
    ...
    public static String ggHttpGet(String uri, String json, String cagent) throws Exception {
        String result = null;
        uri = uri + "?" + json;
        //创建 builder
        HttpClient.Builder builder = HttpClient.newBuilder();
        ...
        HttpClient client = builder
                ...
                .executor(httpPool)
                .build();
        log.info("三方入参json=" + json);
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(uri))
                .header("GGaming", "WEB_GG_GI_" + cagent)
                .GET()
                .build();
    ...
    public static String postHttp(String uri, String params) {
        ...
        try {
            ...
            if (conn.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                log.info("rsp:" + response.toString());
            } else {
                log.info("response>>>" + conn.getResponseMessage());
                log.info("rsp code:" + conn.getResponseCode());
            }
