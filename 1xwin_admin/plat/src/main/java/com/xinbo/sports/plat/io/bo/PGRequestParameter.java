...
public interface PGRequestParameter {
    ...
    class FundTransfer {
        ...
        @JSONField(name = "transfer_reference")
    ...
    class BetDetail {
        ...
        @JSONField(name = "winAmount", serializeUsing = BigDecimal.class)
        private BigDecimal winAmount;
        @JSONField(name = "jackpotContributionAmount", serializeUsing = BigDecimal.class)
        private BigDecimal jackpotContributionAmount;
        @JSONField(name = "jackpotWinAmount", serializeUsing = BigDecimal.class)
        private BigDecimal jackpotWinAmount;
        @JSONField(name = "balanceBefore", serializeUsing = BigDecimal.class)
        private BigDecimal balanceBefore;
        @JSONField(name = "balanceAfter", serializeUsing = BigDecimal.class)
        private BigDecimal balanceAfter;
        @JSONField(name = "handsStatus")
        private Integer handsStatus;
        @JSONField(name = "rowVersion")
        private String rowVersion;
        @JSONField(name = "betTime")
        private String betTime;
        @JSONField(name = "betEndTime")
