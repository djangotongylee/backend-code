...
@Slf4j
@Service
public class CQ9GameServiceImpl extends CQ9ServiceImpl {
    @Override
    public PlatFactoryParams.PlatGameLoginResDto login(PlatFactoryParams.PlatLoginReqDto reqDto) {
        ...
        return PlatFactoryParams.PlatGameLoginResDto.builder().type(1).url(parseObject(send.getString("data")).getString("url")).build();
    }
}
