package com.xinbo.sports.backend.configuration;
...
public class TransactionConfig {
    ...
    /**
     * 配置全局事务的切点为com.xinbo.sports包及子包下的所有方法  AOP切面表达式 可参考（https://blog.csdn.net/ycf921244819/article/details/106599489）
     */
    private static final String AOP_POINTCUT_EXPRESSION = "execution ( * com.xinbo.sports.dao.generator..*.*(..))"
            + " || execution ( * com.xinbo.sports.backend..*.*(..)) ";
