...
public interface AgentCenterParameter {
    ...
    class AgentCommissionList {
        ...
        private BigDecimal coin;
        @ApiModelProperty(name = "subUids", value = "下级UIDS", example = "11,22,45")
        private String subUids;
        @ApiModelProperty(name = "subBetTrunover", value = "投注总额/会员数", example = "100.11/3")
        private String subBetTrunover;
        @ApiModelProperty(name = "category", value = "佣金类型:0-流水佣金 1-活跃会员佣金 2-满额人头彩金；字典key:dic_coin_commission_category", example = "2")
        private Integer category;
