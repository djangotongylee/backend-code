...
public interface ReportCenter {
    ...
    class DailyConversionReportListResBody {
        ...
        @ApiModelProperty(name = "activeNum", value = "活跃人数", example = "26582")
        ...
        @ApiModelProperty(name = "thirdDepositCoin", value = "三存金额", example = "119737.00")
        private BigDecimal thirdDepositCoin;

        @ApiModelProperty(name = "thirdDepositCount", value = "三存笔数", example = "164")
        private Integer thirdDepositCount;
