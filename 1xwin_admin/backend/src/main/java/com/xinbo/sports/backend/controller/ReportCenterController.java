...
import com.xinbo.sports.backend.service.impl.DailyReportExStatisticsServiceImpl;
import com.xinbo.sports.backend.service.impl.PlatformProfitReportServiceImpl;
...
public class ReportCenterController {
    ...
    public Result<CapitalStatisticsListResBody> userZH(@Valid @RequestBody CapitalStatisticsListReqBody reqBody) {
        ...
        if (null != reqBody) {
            resBody.setCoinYXYK(resBody.getCoinYXYK().negate());
        }
