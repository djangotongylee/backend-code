package com.xinbo.sports.backend.configuration.tenant;
...
import static com.xinbo.sports.backend.configuration.tenant.MyTenantParser.METHOD_FLAG;
...
public class MyTenantHandler implements TenantHandler {
    ...
    public Expression getTenantId(boolean select) {
        ...
        if (METHOD_FLAG.get().equals("SELECT") || (isExistTable) && METHOD_FLAG.get().equals("DELETE")) {
        ...
        } else if ((METHOD_FLAG.get().equals("INSERT") || (METHOD_FLAG.get().equals("UPDATE")))) {
    ...
    public String getTenantIdColumn() {
        ...
        if (METHOD_FLAG.get().equals("INSERT") || (METHOD_FLAG.get().equals("UPDATE"))) {
            str = "updated_at";
        }
        return str;
    }
