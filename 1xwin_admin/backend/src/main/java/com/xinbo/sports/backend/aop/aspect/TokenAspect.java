package com.xinbo.sports.backend.aop.aspect;
        ...
        import com.xinbo.sports.backend.base.HeaderBase;
...
public class TokenAspect {
    ...
    @Pointcut("execution(* com.xinbo.sports.backend.controller..*(..)) && !@annotation(com.xinbo.sports.backend.aop.annotation.UnCheckToken)")
