...
public interface System {
    ...
    class BannerListReqBody {
        ...
        private String lang;
        @ApiModelProperty(name = "category", value = "类型:1-首页 2-活动", example = "1")
    ...
    class BannerListResBody {
        ...
        @ApiModelProperty(name = "href", value = "外链", example = "xbsp://reward?type=1")
        private String href;
    ...
    class PlatConfigDto {
        ...
        @ApiModelProperty(name = "lang", value = "国际化语言", example = "en")
        private List<String> lang;
        @ApiModelProperty(name = "staticServer", value = "静态服务器地址", example = "en")
        ...
        private String sms;
        @ApiModelProperty(name = "download", value = "app首页下载地址", example = "")
        private String download;
        @ApiModelProperty(name = "downloadShow", value = "app首页下载是否展示；0-不显示，1-显示", example = "")
        private String downloadShow;
        @ApiModelProperty(name = "downloadLogo", value = "app首页下载Logo的URL", example = "")
