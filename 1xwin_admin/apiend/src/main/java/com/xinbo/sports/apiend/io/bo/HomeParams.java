...
public interface HomeParams {
    ...
    @AllArgsConstructor
    class IndexResDto {
        @ApiModelProperty(name = "game", value = "游戏类型")
        public List<GameIndexResDto> game;
        @ApiModelProperty(name = "banner", value = "Banner图片")
        public List<BannerResDto> banner;
        @ApiModelProperty(name = "notice", value = "公告")
        public ResPage<NoticeResDto> notice;
        @ApiModelProperty(name = "matchPreview", value = "赛事预告")
        public ResPage<BetslipsDetailDto.SportSchedule> matchPreview;
    }
