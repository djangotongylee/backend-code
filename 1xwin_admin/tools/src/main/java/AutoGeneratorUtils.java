...
public class AutoGeneratorUtils {
    private static DB_CONFIG config = DB_CONFIG.NETTY;
    ...
    private static StrategyConfig getStrategyConfig() {
        ...
        strategyConfig.setTablePrefix("sp_");
        // 字段前缀
...
//        strategyConfig.setInclude("my_user");
    ...
    public enum DB_CONFIG {
         ...
         * Netty 数据库配置
         */
        NETTY("java", "java123456", "jdbc:mysql://103.243.183.214:3306/sptest?tinyInt1isBit=false&allowMultiQueries=true&useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&", "com.xinbo.sports.dao", "/dao/src/main/java"),
        ;
