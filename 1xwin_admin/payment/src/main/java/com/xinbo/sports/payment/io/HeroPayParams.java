 ...
 * @date: 14/07/2020
 */
public interface HeroPayParams {
    /**
     * 语言
     */
    @Getter
    ...
    enum HeroPayUrlEnum {
         ...
         * 接口请求
         */
        PAY("deposit", "/api/pay/create_order"),
        TRANS("withdraw", "/api/trans/create_order"),
        CHECK("check", "/api/pay/query_order"),
        CHECK_WITHDRAWAl("checkWithdrawal", "/api/trans/query_order"),
        ;

        private String name;
        private String url;

        HeroPayUrlEnum(String name, String url) {
            this.name = name;
            this.url = url;
        }
    }
