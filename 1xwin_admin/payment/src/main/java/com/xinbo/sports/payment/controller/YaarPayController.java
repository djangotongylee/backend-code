...
import com.xinbo.sports.payment.utils.YaarPayUtil;
...
@Slf4j
@RestController
@Api(tags = "支付回调-YaarPay")
@ApiSort(1)
@RequestMapping("/v1/yaarPay")
@RequiredArgsConstructor(onConstructor = @__(@Autowired))
public class YaarPayController {
    private final YaarPayUtil yaarPayUtil;
    ...
    public String notifyUrl(@Valid @RequestParam Map<String, String> dto) {
        return yaarPayUtil.notifyUrl(dto);
    }
    ...
    public String withdrawNotifyUrl(@Valid @RequestParam Map<String, String> dto) {
        return yaarPayUtil.withdrawNotifyUrl(dto);
    }
}
